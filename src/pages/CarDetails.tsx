    ...
    >
          ...
          >
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-8 md:gap-20">
              ...
              <div className="flex gap-4">
                <span className="text-sm font-['Satoshi-medium'] uppercase tracking-widest text-white/50">
                  Scroll to explore
                </span>
              </div>
            </div>
        ...
        >
          ...
          <div className="space-y-8">
            {car.longDescription?.map((para, i) => (
              <p
                key={i}
                className="font-['Satoshi-light'] text-xl text-gray-400 leading-relaxed"
              >
                {para}
              </p>
            ))}
      ...
      <section className="py-32 px-6 md:px-20 bg-white/5 backdrop-blur-3xl rounded-[3rem] mx-4 md:mx-10 my-20">
        <div className="flex flex-col md:flex-row justify-between items-baseline mb-20 gap-8">
          <h2 className="font-['Boska'] text-5xl md:text-8xl uppercase font-bold">
            Technical <br /> Mastery
          </h2>
          <p className="font-['Satoshi-medium'] uppercase tracking-widest text-white/40">
            Specifications & Data
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {car.specs?.map((spec, i) => (
            ...
            >
              ...
              <div>
                <p className="text-sm font-['Satoshi-medium'] uppercase tracking-widest text-white/40 mb-1">
                  {spec.label}
                </p>
                <p className="text-3xl font-['Boska'] font-bold">
                  {spec.value}
                </p>
              </div>
            </motion.div>
      ...
      {car.gallery && car.gallery.length > 1 && (
        <section className="py-32 px-6 md:px-20">
          <h2 className="font-['Boska'] text-5xl md:text-7xl mb-20 text-center">
            Visual Narrative
          </h2>
            ...
            {car.gallery.map((img, i) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
                  <span className="font-['Satoshi-medium'] uppercase tracking-tighter text-sm">
                    View Detail
                  </span>
                </div>
              </motion.div>
      ...
      <section className="py-40 px-6 md:px-20 text-center relative">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="font-['Boska'] text-6xl md:text-9xl font-bold uppercase mb-12">
            Experience <br /> The {car.title}
          </h2>
          <button
            onClick={() => navigate("/")}
            style={{
